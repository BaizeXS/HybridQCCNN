...
class TestResNet:
    ...
    def simple_resnet(self, request):
    ...
    @pytest.fixture(params=[18, 34])
    def hybrid_resnet(self, request):
    ...
    def test_simple_resnet_initialization(self, simple_resnet):
    ...
    def test_hybrid_resnet_initialization(self, hybrid_resnet):
    ...
    def test_simple_resnet_forward(self, simple_resnet, sample_input):
    ...
    def test_hybrid_resnet_forward(self, hybrid_resnet, sample_input):
    ...
    def test_hybrid_resnet_output_modes(self, sample_input, output_mode):
    ...
    def test_hybrid_resnet_aggregation_methods(self, sample_input, method):
    ...
    def test_models_output_compatibility(
        self, simple_resnet, hybrid_resnet, sample_input
    ):
    ...
    def test_residual_connections(self, simple_resnet, hybrid_resnet, sample_input):
