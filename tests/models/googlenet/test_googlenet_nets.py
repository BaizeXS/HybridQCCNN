...
class TestGoogLeNet:
    ...
    def test_hybrid_googlenet_initialization(self, hybrid_googlenet):
    ...
    def test_simple_googlenet_forward(self, simple_googlenet, sample_input):
    ...
    def test_hybrid_googlenet_forward(self, hybrid_googlenet, sample_input):
    ...
    def test_hybrid_googlenet_output_modes(self, sample_input, output_mode):
    ...
    def test_hybrid_googlenet_aggregation_methods(self, sample_input, method):
    ...
    def test_models_output_compatibility(
        self, simple_googlenet, hybrid_googlenet, sample_input
    ):
