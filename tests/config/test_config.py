...
def test_quantum_config():
    ...
    assert quantum_config.q_device_kwargs is not None
...
def test_path_resolution():
    ...
    config = Config(
        ...
        data=DataConfig(
            ...
            num_classes=10,
            dataset_type="CIFAR10",
            dataset_path=Path("datasets/custom"),
        ),
        model=ModelConfig(name="test", model_type="classic", model_kwargs={}),
        training=TrainingConfig(),
...
def test_config_validation(config_manager):
    ...
    invalid_config = {
        ...
        "model": {"name": "test_model", "model_type": "classic"},
        "training": {
            "learning_rate": 0.001,
            "weight_decay": 1e-4,
            "num_epochs": 10,
...
def test_training_config():
    ...
    training_config = TrainingConfig(
        learning_rate=0.001, weight_decay=1e-4, num_epochs=10, checkpoint_interval=1
    )
