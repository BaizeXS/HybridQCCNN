...
# Test parameters
TEST_PARAMS = {"batch_size": 4, "input_dim": 5, "num_classes": 3, "dataset_size": 20}
...
def trainer(sample_model):
    ...
    return Trainer(model=sample_model, criterion=criterion, optimizer=optimizer)
...
def test_metrics_calculator():
    ...
    outputs = torch.tensor([[0.1, 0.8, 0.1], [0.7, 0.2, 0.1], [0.1, 0.1, 0.8]])
