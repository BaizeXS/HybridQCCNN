    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.layer1 = self._make_layer(
            block, 16, num_blocks[0], stride=1, use_quanv2d=False, **kwargs
        )
        self.layer2 = self._make_layer(
            block, 32, num_blocks[1], stride=2, use_quanv2d=False, **kwargs
        )
        self.layer3 = self._make_layer(
            block, 64, num_blocks[2], stride=2, use_quanv2d=True, **kwargs
        )
        self.layer4 = self._make_layer(
            block, 128, num_blocks[3], stride=2, use_quanv2d=True, **kwargs
        )
