...
class ConfigManager:
    ...
    REQUIRED_FIELDS = {
        "data": {"name", "input_shape", "num_classes", "dataset_type", "batch_size"},
        "model": {"name", "model_type"},
        "training": {"learning_rate", "weight_decay", "num_epochs"},
        "root": {"name", "version", "description", "data", "model", "training"},
    }
